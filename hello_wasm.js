...
/**
* @param {number} name_len_min
* @param {number} name_len_max
* @param {number} max_number
* @returns {string}
*/
export function user(name_len_min, name_len_max, max_number) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.user(retptr, name_len_min, name_len_max, max_number);
...
* @returns {string}
*/
export function pass(word_size, word_count) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.pass(retptr, word_size, word_count);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        return getStringFromWasm0(r0, r1);
    } finally {
